      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            ...
            {/* Top Pill Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-100 text-[#0038A8] border border-slate-200 text-xs font-extrabold uppercase tracking-widest mb-6">
              <span>CLIENT PORTAL</span>
            </div>

            {/* Main Headline */}
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0038A8] tracking-tight leading-tight mb-6">
            ...
            <ul className="space-y-4 mb-10 w-full">
              <li className="flex items-center gap-3 text-sm text-slate-700 font-medium">
                <div className="w-5 h-5 rounded-full bg-slate-100 text-[#0038A8] flex items-center justify-center shrink-0">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto">
              <Link
                href="/login"
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl text-sm font-bold text-white bg-[#0038A8] hover:bg-[#002266] shadow-md shadow-[#0038A8]/20 transition-all duration-200"
              >
              ...
              <Link
                href="#book"
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl text-sm font-bold text-[#0038A8] bg-white hover:bg-slate-100 border-2 border-[#0038A8]/30 shadow-xs transition-all duration-200"
              >
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-soft-xl relative">
              ...
              <div className="mb-8">
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl sm:text-4xl font-extrabold text-[#0038A8] tracking-tight">
                    $640,000
                  </span>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3.5">
                  <div className="w-6 h-6 rounded-full bg-[#0038A8] text-white flex items-center justify-center shrink-0">
                    <Check className="w-3.5 h-3.5 stroke-[3]" />
                  </div>
