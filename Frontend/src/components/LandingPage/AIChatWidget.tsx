 ...
 *  - Real-time RAG integration connected to Django backend /api/ai/chat/
 *  - Smooth typewriter / stream typing animation for AI responses
 *  - Animated bouncing 3-dot typing indicator while processing
 *  - Quick prompt suggestions, message auto-scrolling, reset conversation
...
const SUGGESTED_PROMPTS = [
  { label: "Loan Eligibility 💡", prompt: "What are the loan eligibility requirements for first-home buyers?" },
  { label: "Bai Remittance 💸", prompt: "What is Bai Remittance and what are its features and payout channels?" },
  { label: "Bai Lawyers & Visas ⚖️", prompt: "What services does Bai Lawyers and Migration division offer?" },
  { label: "Leadership & Team 👥", prompt: "Who leads Bai Finance and where are your offices located?" },
];
